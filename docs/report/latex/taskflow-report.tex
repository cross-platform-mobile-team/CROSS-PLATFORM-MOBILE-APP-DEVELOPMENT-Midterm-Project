...
Evaluation separates source identity, test selection, environment and observed outcome. The evaluated implementation is commit 3e4f733. Logs under \nolinkurl{docs/evidence/platform-audit-20260914} and \nolinkurl{docs/evidence/platform-audit-20260915} record the local audit. On 15 September, the Flutter suite passed 100 cases with coverage enabled and the Node suite passed 14 cases; publication review repeated both successfully. Earlier browser and hosted Android experiments keep their original evidence identities.
...
Flutter suite with coverage & 100 cases PASS on 15 September & Includes draft-consistency cases and goldens; no coverage percentage asserted \\ \addlinespace[5pt]
Node API suite & 14 cases PASS on 15 September & Local HTTP, account and SQLite behaviors \\ \addlinespace[5pt]
Windows workflows & 15 cases PASS on 14 September & Six separate invocations, including real API/SQLite \\ \addlinespace[5pt]
...
\noindent\hangindent=0.75cm\hangafter=1 TaskFlow project. (2026). TaskFlow QA Lab [Source code and test evidence, revision 3e4f733]. \nolinkurl{https://github.com/cross-platform-mobile-team/CROSS-PLATFORM-MOBILE-APP-DEVELOPMENT-Midterm-Project/tree/3e4f733acfcb219596aa4b60376f41b142d65857}\par\medskip
