...
| Experiments | Search mutation; repeated browser workflow | Intentional-defect fail/fix artifacts; five-run Edge timing experiment | Broader sessions/hosts, report comparison and uncertainty |
